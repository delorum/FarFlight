...
func _draw_menu_button(rect: Rect2, text: String) -> void:
	...
	draw_string(ThemeDB.fallback_font, rect.position + Vector2(10, 32), text, HORIZONTAL_ALIGNMENT_CENTER, rect.size.x - 20, 14, AircraftArt.INK)
