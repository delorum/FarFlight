...
func _init() -> void:
	...
	assert(is_equal_approx(economy.fuel_price_per_l(economy.fuel_airports[0]), 0.7))
	assert(is_equal_approx(economy.fuel_price_per_l(economy.fuel_airports[1]), 1.0))
	assert(is_equal_approx(economy.fuel_price_per_l(economy.fuel_airports[2]), 1.3))
	assert(economy.food_price(economy.food_airports[0]) == 8)
	assert(economy.food_price(economy.food_airports[1]) == 12)
	assert(economy.food_price(economy.food_airports[2]) == 16)
	assert(economy.hotel_rest_price(economy.hotel_airports[0]) == 4)
	assert(economy.hotel_rest_price(economy.hotel_airports[1]) == 6)
	assert(economy.hotel_rest_price(economy.hotel_airports[2]) == 8)
	...
	assert(economy.money == fuel_money_before - 14)
	...
	assert(is_equal_approx(restored.fuel_price_per_l(restored.fuel_airports[2]), 1.3))
